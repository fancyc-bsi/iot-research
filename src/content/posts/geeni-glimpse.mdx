...
I have no attempted to see how the device is waiting for the UDP broadcast yet, but will attempt to do so.
---
...
What would potentially work is decompiling the binary with ghidra, making some edits and repacking it. But that will be out of scope for now.